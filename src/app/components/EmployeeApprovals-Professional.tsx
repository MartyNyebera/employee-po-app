...
import { UserCheck, X, Check, Search, RefreshCw, Mail, Phone, Calendar, User, Shield } from 'lucide-react';
import { fetchPendingEmployees, approveEmployee, rejectEmployee } from '../api/client';
...
export function EmployeeApprovals({ onApprove, onReject, userName }: EmployeeApprovalsProps) {
  ...
  const handleApprove = async (id: string) => {
    setProcessingId(id);
    try {
      await approveEmployee(id, userName || 'Admin');
  ...
  const handleReject = async (id: string) => {
    setProcessingId(id);
    try {
      await rejectEmployee(id, userName || 'Admin');
    ...
    <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Review and approve employee account requests
            </p>
          </div>
        </div>
        <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            type="text"
            placeholder="Search by full_name, email, or department..."
            value={searchTerm}
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <UserCheck style={{ width: '14px', height: '14px', color: '#6b7280' }} />
                          <span style={{
                            fontSize: '14px',
                            color: '#6b7280',
                            fontFamily: 'Inter, sans-serif'
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: '500',
                        fontFamily: 'Inter, sans-serif',
                        cursor: processingId === employee.id ? 'not-allowed' : 'pointer',
                        opacity: processingId === employee.id ? 0.5 : 1,
                        transition: 'all 0.2s ease',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '6px'
                    ...
                    >
                      ...
                      {processingId === employee.id ? 'Processing...' : 'Reject'}
                    </button>
                  </div>
                </div>
              </div>
