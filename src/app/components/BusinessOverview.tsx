          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-2xl font-bold text-slate-900">
                {metrics ? formatCurrency(metrics.expenses) : '₱0'}
              </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className={`flex items-center gap-1 text-sm ${metrics && metrics.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <span>{metrics ? (metrics.netProfit >= 0 ? 'Profit' : 'Loss') : 'Neutral'}</span>
              </div>
            </div>
            <div className="space-y-1">
              ...
              <p className={`text-2xl font-bold ${metrics && metrics.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {metrics ? formatCurrency(metrics.netProfit) : '₱0'}
              </p>
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{inventorySummary?.totalItems || 0}</div>
                <div className="text-xs text-slate-500">Total Items</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{inventorySummary?.activeItems || 0}</div>
                <div className="text-xs text-slate-500">Active Items</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-slate-400">{inventorySummary?.totalItems && inventorySummary?.activeItems ? inventorySummary.totalItems - inventorySummary.activeItems : 0}</div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium">{inventorySummary?.inStock || 0}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{inventorySummary?.lowStock || 0}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{inventorySummary?.outOfStock || 0}</span>
              </div>
            </div>
          </CardContent>
        </Card>
