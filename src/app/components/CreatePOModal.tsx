...
export function CreatePOModal({ onClose, onCreated }: CreatePOModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[99999] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md" style={{ backgroundColor: 'white', background: 'white' }}>
        {/* Header */}
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="p-6 space-y-4" style={{ backgroundColor: 'white', background: 'white' }}>
          <div>
